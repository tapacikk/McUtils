...
setup(
    ...
    data_files=[
        ...
        ('share/jupyter/labextensions/ActiveHTMLWidget', glob.glob('McUtils/Jupyter/JHTML/ActiveHTMLWidget/labextension/*.js') + ['McUtils/Jupyter/JHTML/ActiveHTMLWidget/install.json']),
