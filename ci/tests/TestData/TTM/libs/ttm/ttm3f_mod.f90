...
!   use ttm3f_mod
   ...
   subroutine ttm3f(Nw,RR,dRR,En)
      ...
      call ttm3f_inner(Nw,RR,dRR,En, &
              Natsq, Natsd, Nats, fO, lO, fH, lH, fM, lM, fO3, lO3, fH3, lH3, fM3, lM3)
   end subroutine ttm3f

   subroutine ttm3f_inner(Nw,RR,dRR,En, &
           Natsq, Natsd, Nats, fO, lO, fH, lH, fM, lM, fO3, lO3, fH3, lH3, fM3, lM3)
...
!   use ttm3f_mod
   ...
   integer, intent(in) :: Nats, Natsd, Natsq
   !
   ...
   double precision, dimension(fM3:lM3) :: dip
   double precision, dimension(fM3:lM3) :: pr_dip
   double precision, dimension(fH:lM) :: phi
   double precision, dimension(fO3:lM3) :: Efq
   double precision, dimension(fM3:lM3) :: Efd
   double precision, dimension(fM3:lM3, fM3:lM3) :: DDT
